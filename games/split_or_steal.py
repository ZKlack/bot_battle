...
def judge():
    ...
    if move[1] not in moves:
        disqualify(1)
    if move[0] == "steal" and move[1] == "steal":
        zudge.print("st"," ")
    if move[0] == "steal" and move[1] == "split":
        zudge.print("p0"," ")
        score[0] += 2
    if move[0] == "split" and move[1] == "steal":
        zudge.print("p1"," ")
        score[1] += 2
    if move[0] == "split" and move[1] == "split":
        zudge.print("sp"," ")
        score[0] += 1
        score[1] += 1
